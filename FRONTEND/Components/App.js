...
export default class                                                             App extends Component {
    ...
    //                     fetch('http://10.0.13.130/MealRecommendationApplication-Project/api/saveData.php',
    //                     {   
    //                         method: 'POST',
    //                         headers: {
    ...
    //                     }
    //                     fetch('http://10.0.13.130/MealRecommendationApplication-Project/api/updateMenu.php',
    //                     {   
    //                         method: 'POST',
    //                         headers: {
    //                             'Content-Type': 'application/json',

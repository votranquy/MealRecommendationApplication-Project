...
export default class Category extends Component {
  ...
  // fetchData(){
  //   fetch("http://192.168.21.250/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+this.state.page ,
  ...
  componentDidMount(){
    fetch("http://192.168.21.250/MealRecommendationApplication-Project/BACKEND/category.php",
      {method:"GET",
      headers: {
  ...
  //   fetch("http://192.168.21.250/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+this.state.page,{method:"POST",body:null})
  //   .then((response)=>response.json())
  //   .then((responseData)=>{
  //     this.setState({
  //       dataSource: this.state.dataSource.cloneWithRows(responseData),
...
//   _onEndReached(){
//     fetch("http://192.168.21.250/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+(this.state.page+1),
//       {
//         method:"POST",
//         headers: {
//           'Content-Type': 'application/json',

...
const Img_Path= 'http://10.0.23.29/MealRecommendationApplication-Project/BACKEND/CRAWL_DATA/IMAGE/';
var URL="http://10.0.23.29/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber=";
...
export default class ListFood extends Component {
  ...
  fetchData(){
    fetch("http://10.0.23.29/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+this.state.page ,
  ...
  loadNewData(){
    ...
    fetch("http://10.0.23.29/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+this.state.page,{method:"POST",body:null})
    .then((response)=>response.json())
    .then((responseData)=>{
      this.setState({
        dataSource: this.state.dataSource.cloneWithRows(responseData),

...
var URL="http://10.10.31.172/MealRecommendationApplication-Project/BACKEND/RanDom.php?pagenumber=";
...
export default class Random extends Component {
  ...
  fetchData(){
    fetch("http://10.10.31.172/MealRecommendationApplication-Project/BACKEND/RanDom.php?pagenumber="+this.state.page ,
  ...
  loadNewData(){
    ...
    fetch("http://10.10.31.172/MealRecommendationApplication-Project/BACKEND/RanDom.php?pagenumber="+this.state.page,{method:"POST",body:null})
    .then((response)=>response.json())
    .then((responseData)=>{
      this.setState({
        dataSource: this.state.dataSource.cloneWithRows(responseData),

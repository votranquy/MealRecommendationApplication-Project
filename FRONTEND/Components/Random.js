...
// var URL="http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/RanDom.php?pagenumber=";
...
export default class Random extends Component {
  ...
  componentDidMount(){
    fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/RanDom.php?pagenumber="+this.state.page,
      {method:"POST",
      headers: {
...
creatStar5(score){
  ...
  _onEndReached(){
    fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/RanDom.php?pagenumber="+(this.state.page+1),
      {
        method:"POST",
        headers: {
          'Content-Type': 'application/json',

...
// const Img_Path= 'http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/CRAWL_DATA/IMAGE/';
// var URL="http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Restaurant.php?pagenumber=";
...
export default class Restaurant extends Component {
  ...
  componentDidMount(){
    fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Restaurant.php?pagenumber="+this.state.page,
      {method:"POST",
      headers: {
...
creatStar5(score){
  ...
  //   fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Restaurant.php?pagenumber="+this.state.page,{method:"POST",body:null})
  //   .then((response)=>response.json())
  //   .then((responseData)=>{
  //     this.setState({
  ...
  _onEndReached(){
    fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Restaurant.php?pagenumber="+(this.state.page+1),
      {
        method:"POST",
        headers: {
          'Content-Type': 'application/json',

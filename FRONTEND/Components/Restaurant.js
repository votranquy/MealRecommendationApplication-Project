...
// var URL="http://10.0.12.57/MealRecommendationApplication-Project/BACKEND/Restaurant.php?pagenumber=";
...
creatStar5(score){
  ...
  //   fetch("http://10.0.12.57/MealRecommendationApplication-Project/BACKEND/Restaurant.php?pagenumber="+this.state.page,{method:"POST",body:null})
  //   .then((response)=>response.json())
  //   .then((responseData)=>{
  //     this.setState({

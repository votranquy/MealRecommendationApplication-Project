...
// var URL="http://10.0.12.47/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber=";
...
export default class TopFood extends Component {
  ...
  componentDidMount(){
    fetch("http://10.0.12.47/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+this.state.page,
      {method:"POST",
      headers: {
...
creatStar5(score){
  ...
  _onEndReached(){
    fetch("http://10.0.12.47/MealRecommendationApplication-Project/BACKEND/HomePage.php?pagenumber="+(this.state.page+1),
      {
        method:"POST",
        headers: {
          'Content-Type': 'application/json',

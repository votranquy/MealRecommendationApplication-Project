...
// var URL="http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber=";
...
export default class Trend extends Component {
  ...
  componentDidMount(){
    fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+this.state.page,
      {method:"POST",
      headers: {
...
creatStar5(score){
  ...
  //   fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+this.state.page,{method:"POST",body:null})
  //   .then((response)=>response.json())
  //   .then((responseData)=>{
  //     this.setState({
  ...
  _onEndReached(){
    fetch("http://10.10.31.156/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+(this.state.page+1),
      {
        method:"POST",
        headers: {
          'Content-Type': 'application/json',

...
export default class Trend extends Component {
  ...
  componentDidMount(){
    fetch("http://10.0.13.130/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+this.state.page,
      {method:"POST",
      headers: {
  ...
  _onEndReached(){
    fetch("http://10.0.13.130/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+(this.state.page+1),
      {
        method:"POST",
        headers: {
          'Content-Type': 'application/json',

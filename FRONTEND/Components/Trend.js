...
var URL="http://10.0.12.37/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber=";
...
export default class Trend extends Component {
  ...
  fetchData(){
    fetch("http://10.0.12.37/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+this.state.page ,
  ...
  loadNewData(){
    ...
    fetch("http://10.0.12.37/MealRecommendationApplication-Project/BACKEND/Trend.php?pagenumber="+this.state.page,{method:"POST",body:null})
    .then((response)=>response.json())
    .then((responseData)=>{
      this.setState({
        dataSource: this.state.dataSource.cloneWithRows(responseData),

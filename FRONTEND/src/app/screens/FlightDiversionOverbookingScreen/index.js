...
class FlightDiversionOverbookingScreen extends Component {
  static propsType = {};
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      defaultValue3: 'FLIGHT DIVERSION 1',
      currentPosition: 0,
  ...
  render() {
    const {
      currentPosition, defaultValue1, defaultValue2, defaultValue3, dateDefault,
    } = this.state;
    return (
      <View>
        <ScrollView>
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.titleScreen}>{i18n.t('SCFDO.FlightDiversionAndOverbookedFlights')}</Text>
            <Text style={styles.desText}>
              {i18n.t('SCFDO.FlightDiversionAndOverbookedFlightsDes')}
            </Text>
          </View>
          ...
          <View style={styles.inputContainer}>
            <Text style={styles.titleSelect}>{i18n.t('SCF.TypeOfIncident')}</Text>
            <View style={styles.selectBorder}>
              <Dropdown
                dropdownOffset={{ top: 15, left: 0 }}
                value={defaultValue3}
...
export default FlightDiversionOverbookingScreen;

...
class MissedConnectingFlightScreen extends Component {
  static propsType = {};
      ...
      <View>
        <ScrollView>
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.titleScreen}>{i18n.t('SCMCF.MissedConnectingFlight')}</Text>
            <Text style={styles.desText}>
              {i18n.t('SCMCF.MissedConnectingFlightDes')}
            </Text>
          </View>
          ...
          <View style={styles.inputContainer}>
            ...
            <DatePicker
              ...
              onDateChange={(dateDefault) => { this.setState({ dateDefault: !dateDefault }); }}
            />
          </View>

          <View style={styles.inputContainer}>
            <Text style={styles.titleSelect}>{i18n.t('SCF.InboundFlightNumber')}</Text>
            <TextInput style={styles.textInput} placeholder={i18n.t('SCF.FlightNo')} />
          </View>

          <View style={styles.inputContainer}>
            <Text style={styles.titleSelect}>{i18n.t('SCF.MinedConnectingFlightNumber')}</Text>
            <TextInput style={styles.textInput} placeholder={i18n.t('SCF.FlightNo')} />
          </View>

          <View style={styles.inputContainer}>
            <Text style={styles.titleSelect}>{i18n.t('SCF.RebookedFlightNumber')}</Text>
            <TextInput style={styles.textInput} placeholder={i18n.t('SCF.FlightNo')} />
          </View>
          ...
          <View style={[styles.inputContainer, styles.imageUploadContainer]}>
            ...
            <Text style={styles.titleImageUpload}>{i18n.t('SCF.ImageOfLetterFromCarrier')}</Text>
          </View>

          <View style={styles.btnContainer}>
            <Button style={styles.buttonNextStep} text={i18n.t('CM.Next')} />
          </View>
        </ScrollView>
      </View>
...
export default MissedConnectingFlightScreen;
